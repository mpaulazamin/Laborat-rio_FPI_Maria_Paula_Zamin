...
%
% Q2 and Q3 (a): read and display the kernel
%
figure;
subplot(1, 2, 1)
...
%
% Q2 and Q3 (b): replace 255 values by 1 to have a binary (0, 1) mask
%
filter_m(:,:) = filter(:,:,1);
...
%
% Q2 and Q3 (c): Read cameraman.tif and compute its Fourier transform
%
figure;
subplot(2, 3, 1)
...
%
% Q2 and Q3 (d): Visualize cameraman.tif and its DFT, and apply a shift
%
subplot(2, 3, 2)
...
%
% Q2 and Q3 (e): Multiply the shifted spectrum by the mask
%
...
%
% Q2 and Q3 (f): Undo the shift and show the result
%
...
%
% Q2 and Q3 (g): Apply the inverse Fourier transform and show the filtered image
%
